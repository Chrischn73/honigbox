...
if [ -z "$TEXT" ]; then
  case "$MELDUNG_ID" in
    ...
    eskalation1) TEXT="HONIGBOX Tür steht seit ca. 3 Minuten offen! Warte weitere 30 Min bis zur nächsten Prüfung..." ;;
    eskalation2) TEXT="HONIGBOX Tür steht seit ca. 33 Minuten offen!" ;;
